...
class DateAndRepeatView: UIView {
    ...
    private func setupViews() {
        ...
        dateStackView = UIStackView(arrangedSubviews: [dateLabel, datePicker], spacing: 10)
        backView.addSubview(dateStackView)
        
        repeatStackView = UIStackView(arrangedSubviews: [repeatLabel, repeatSwitch], spacing: 10)
